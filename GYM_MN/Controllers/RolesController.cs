...
namespace GYM_MN.Controllers
{
    ...
    public class RolesController : ControllerBase
    {
        ...
        public RolesController(GymMnContext context)
        {
            _context = context;
        }
        ...
        {
            // Kiểm tra xem roleDto có hợp lệ không
            if (!ModelState.IsValid)
            {
                return BadRequest(ModelState);
            }

            // Tạo mới đối tượng Role từ RoleDto
            var role = new Role
            {
                RoleName = roleDto.RoleName
            };

            // Thêm đối tượng Role vào DbSet trong DbContext
